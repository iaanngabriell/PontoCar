...
from . import foto_views, views

app_name = "veiculos"

urlpatterns = [
    path("catalogo/", views.catalogo, name="catalogo"),
    path("api/catalogo/modelos/", views.catalogo_modelos_api, name="catalogo_modelos_api"),
    ...
    path(
        "vendedor/veiculos/<uuid:veiculo_id>/fotos/ordenar/",
        foto_views.reordenar_fotos,
        name="vendedor_fotos_ordenar",
    ),
