...
def build_admin_dashboard():
    ...
    verifs = ""
    for nome, seed_color in [("Speed Auto Center", "#2ea043"), ("TO Corretora de Seguros", "#1a3a5c")]:
        verifs += '''
        <tr>
...
def build_admin_empresas():
    ...
    for nome, cnpj, status, seed_color in [
        ...
        ("Speed Auto Center", "34.567.890/0001-22", ("Documentos enviados","badge-blue"), "#2ea043"),
