    ...
    <div class="panel">
      ...
      <div class="panel-body">
        ...
        <div class="form-row cols-2">
          ...
          <div class="form-group"><label>Categoria</label><select class="form-control"><option>Concessionária</option><option>Revendedora</option><option>Oficina mecânica</option><option>Seguradora</option><option>Corretora de seguros</option></select></div>
        </div>
        <div class="form-row cols-2">
